\chapter{Meccanica dei corpi rigidi}
...
\subsection{Forze parallele nello stesso verso}
...
\subsection{Forze parallele in verso opposto}
...
\subsection{Sollecitazione di un corpo rigido}



\section{Corpo girevole intorno a un asse fisso}
...
\begin{multicols}{2}
    ...
    \subsection*{Sbarra cilindrica sottile}
    ...
    \subsection*{Sfera cava a parete sottile}
    Momento d'inerzia rispetto a un diametro
    \begin{equation*}
        I = \frac{2 m R^2}{3}
    \end{equation*}
...
\section{Energia cinetica di un corpo rigido}
