...
\begin{multicols}{2}
    ...
    \subsubsection*{Lavoro elettrostatico}
    \begin{equation}
        \begin{aligned}
            L_{AB} & = \int_A^B F \ ds =                  \\
                   & = q_0 \int_A^B E \ ds = - \Delta U_e
        \end{aligned}
    \end{equation}
    ...
    \subsubsection*{Potenziale elettrostatico in un punto $P$}

    \begin{equation}
        V = - \int_\infty^P E \ ds
    \end{equation}

    \subsubsection*{Potenziale elettrostatico in una carica $q$}

    \begin{equation}
        V = - \int_\infty^P E \ ds = \frac{1}{4 \pi \varepsilon_0} \frac{q}{r}
    \end{equation}

    \subsubsection*{Energia potenziale di una carica $q$}

    \begin{equation}
        U_e = q_0 V(r) = \frac{1}{4 \pi \varepsilon_0} \frac{q_0 q}{r}
    \end{equation}
    ...
    \begin{equation}
        \frac{1}{2} m v^2 + q_0 V = \mathrm{const}
    \end{equation}

    \subsubsection*{Momento di dipolo elettrico}
