...
\begin{multicols}{2}
    ...
    \subsection*{Lavoro elettrostatico}
    \begin{equation}
        \begin{aligned}
            L_{AB} & = \int_A^B F \ ds =                  \\
    ...
    \subsection*{Potenziale elettrostatico in un punto $P$}

    \begin{equation}
        V = - \int_\infty^P E \ ds
    \end{equation}

    \subsection*{Potenziale elettrostatico in una carica $q$}

    \begin{equation}
        V = - \int_\infty^P E \ ds = \frac{1}{4 \pi \varepsilon_0} \frac{q}{r}
    \end{equation}

    \subsection*{Energia potenziale di una carica $q$}
